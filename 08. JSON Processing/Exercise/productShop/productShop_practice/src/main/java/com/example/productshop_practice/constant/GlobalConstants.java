...
public class GlobalConstants {
  ...
  public static final String USERS_AND_PRODUCTS_OUTPUT = "users_and_products.json";
  ...
  public static final String USERS_AND_PRODUCTS = OUTPUT_RESOURCES_FILE_PATH + USERS_AND_PRODUCTS_OUTPUT;
}
